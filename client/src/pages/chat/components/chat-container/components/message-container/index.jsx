            ...
            <div 
                ...
                {checkIfImage(message.fileUrl) ? (
                    ...
                    <div className='cursor-pointer' onClick={() => {
                      ...
                      <img src={`${HOST}/${message.fileUrl}`} height={300} width={300} alt="Uploaded content" />
                    </div>
                ) : (
                    <div className="text-gray-600 flex items-center justify-center gap-5">
    ...
    md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full'>
      ...
      <div ref={scrollRef} />
      {
        ...
        <div className='fixed z-[1000] top-0 left-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-lg'>
          <div>
            <img src={`${HOST}/${imageURL}`} className='h-[70vh] w-[80vw] bg-cover ' />
          </div>
